...
import { BrandListItemMedium as Component, BrandListItemMediumProps as Props } from '@pui/brandListItemMedium';
...
export interface BrandListItemMediumProps extends Omit<Props, 'onChangeFollow'> {
  // Follow 클릭 콜백
...
/**
 * useWebInterface의 subscribeShowroom가 연동된 BrandListItemMedium 컴포넌트
 */
export const BrandListItemMedium = styled(
  forwardRef<HTMLDivElement, BrandListItemMediumProps>(
