...
import { LiveListItem as Component, LiveListItemProps as Props } from '@pui/liveListItem';

export interface LiveListItemProps extends Omit<Props, 'onChangeFollow'> {
  /** Follow 클릭 콜백 */
 ...
 */
export const LiveListItem = styled(
  forwardRef<HTMLSpanElement, LiveListItemProps>(
