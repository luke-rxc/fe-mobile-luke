...
export default {
  title: `${StoriesMenu.PDS.DataDisplayCardType}/Live/LiveCard`,
  component: LiveCard,
  parameters: {
    design: {
      type: 'figma',
      url: 'https://www.figma.com/file/G08zxegRFA3a1kF0ZMCaXa/PDS?node-id=7334%3A30440',
    },
  },
  args: {
    onAir: false,
...
} as ComponentMeta<typeof LiveCard>;

const Template: ComponentStory<typeof LiveCard> = (args) => <LiveCard {...args} />;
