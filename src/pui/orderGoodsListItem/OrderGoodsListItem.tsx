...
export interface OrderGoodsListItemProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'prefix'> {
  /** 상품 이미지 */
...
const OrderGoodsListItemComponent = forwardRef<HTMLDivElement, OrderGoodsListItemProps>(
  (
    {
      goodsImage,
      brandName,
        ...
        >
          ...
          <div className={`goods-info-box ${brandName == null ? 'no-brand' : ''}`}>
            <div className="goods-info">
              ...
              {(options || quantity) && (
                <GoodsOptions className="goods-options" options={options} quantity={quantity} />
              )}
 ...
 * @deprecated '@pui/orderGoodsListItem/v2'로 대체
 */
