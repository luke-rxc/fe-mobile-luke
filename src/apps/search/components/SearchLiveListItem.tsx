...
import { LiveListItem, LiveListItemProps } from '@pui/liveListItem';
import { TeaserModalContainer as teaserModal } from '@features/schedule/containers';

export interface SearchLiveListItemProps extends Omit<LiveListItemProps, 'onChangeFollow'> {
  // Follow 클릭 콜백
...
export const SearchLiveListItem = styled(
  forwardRef<HTMLSpanElement, SearchLiveListItemProps>((props, ref) => {
    ...
    // 모웹 티저 팝업인 경우 처리
    const handleClickTeaser: SearchLiveListItemProps['onClickLink'] = (e, item) => {
