...
export default {
  title: 'Features/Live/LiveGoodsSlideImages',
  component: LiveGoodsSlideImages,
} as ComponentMeta<typeof LiveGoodsSlideImages>;

const Template: ComponentStory<typeof LiveGoodsSlideImages> = (args) => {
  return (
    <WrapperStyled>
      <LiveGoodsSlideImages {...args} />
    </WrapperStyled>
  );
};
...
export const 썸네일이미지3장이상 = Template.bind({});
썸네일이미지3장이상.args = {
  images: [
    {
      blurHash: 'UyCa*_i]I9WXyZjDjDayW@oet7V@Sja|tRax',
