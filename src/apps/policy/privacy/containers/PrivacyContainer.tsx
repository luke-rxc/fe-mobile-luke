    ...
    <Layout className={isApp ? 'app' : ''} title="개인정보 처리방침" headerTriggerRef={headerTriggerRef}>
      <div id="policy-all">
        ...
        <article ref={headerTriggerRef}>
          <div className="layout-box">
            <p className="layout-text">
              본 약관은 (주)알엑스씨(이하 ‘회사’)에서 제공하는 서비스 이용(APP, Web)에 적용됩니다.
            </p>
          </div>
        </article>
        <article>
          <h2>1. 개인정보의 수집 및 이용 보유 안내</h2>
          <div className="layout-box">
            <p className="layout-text">
          ...
          <p className="layout-title">필수 항목</p>
          <PersonalInfo />
          <p className="layout-title">선택 항목</p>
            ...
            <div className="table-box">
              <table className="table">
                ...
                <tbody>
                  <tr>
                    <td>SNS 간편가입 시</td>
                    <td>SNS 계정 간편가입시 (카카오ID:이름/생일/출생연도/연령대/성별, 애플ID:이메일)</td>
                    <td>
                      - 회사는 원칙적으로 이용자의 개인정보를 회원 탈퇴 및 수집 목적 달성 시 지체없이 안전하게 파기하고,
                      이용자에게 개인정보 보관 기간에 대해 별도 동의를 얻은 경우 해당 동의 내용에 따릅니다.
                      <br />
                      <br />- 이외 법령에 따라 일정 기간 보관해야 하는 항목은 관련 법령에 따릅니다.
                    </td>
                  </tr>
                  <tr>
                    <td>마케팅</td>
                  ...
                  <tr>
                    <td>이벤트/프로모션 운영</td>
                    <td>
                      주문자 정보(휴대폰 인증을 통해 확인한 이름, 휴대폰번호), 결제신용카드정보(카드번호, 카드사명)
                    </td>
                    <td>상동</td>
                  </tr>
                  <tr>
                    <td>구매 취소/환불</td>
                    <td>받는 사람 이름, 휴대폰번호, 배송지주소</td>
                    <td>상동</td>
                  </tr>
                </tbody>
              </table>
        ...
        <article>
          ...
          <div className="layout-box">
            <p className="layout-text">법령에 의하여 수집∙이용되는 회원 정보</p>
          </div>
          <div className="layout-table layout-box">
            <div className="table-box">
              <table className="table">
        ...
        <article>
          ...
          <div className="layout-box">
            ...
            <p className="layout-text">
              회사는 개인정보 유효 기간제에 따라 1년간 서비스를 이용하지 않은 휴면 회원의 개인정보를 별도로 분리
              보관하여 관리하고 있습니다.
            </p>
            <p className="layout-text">
        ...
        <article>
            ...
            <div className="table-box">
              <table className="table">
                ...
                <tbody>
                  <tr>
                    <td>(주)굿스플로</td>
                    <td>배송정보 연동 서비스카카오 알림톡 발송(알리미) 서비스</td>
                  ...
                  <tr>
                    <td>토스페이먼츠(주), NHN한국사이버결제(주), 주식회사 카카오페이, 네이버파이낸셜(주)</td>
                    <td>결제 대행 서비스</td>
                    <td>상동</td>
                  </tr>
                  <tr>
                    <td>Amazon Web Services, Inc.</td>
                    <td>서비스 인프라 구축 및 제공</td>
                    <td>상동</td>
                  </tr>
                  <tr>
                    <td>(주)올마이투어</td>
                    <td>국내 숙박 예약 및 민원 처리 운영</td>
                    <td>상동</td>
                  </tr>
                </tbody>
              </table>
          ...
          <div className="layout-box">
            <p className="layout-text">
              고객 정보 일부는 서비스 향상을 위한 통계분석 등의 목적으로 국외에 위치하고 있는 서버에 저장될 수 있습니다.
            </p>
          </div>
          <div className="layout-table">
            <div className="table-box slide-type">
              <div className="col6">
                <table className="table">
                  <colgroup>
                    <col width="120px" />
                  ...
                  <thead>
                    <tr>
                      <th scope="col">위탁 받는 자</th>
                      <th scope="col">위탁 업무 내용</th>
                      <th scope="col">이전국가 이전일시 및 방법</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        이전국가: 미국
                        <br />
                        이전 일시 및 방법: 개인정보의 처리 필요 시 네트워크를 통한 전송
                      </td>
                      <td>닉네임</td>
                      <td>회원 탈퇴 시 또는 위탁 계약 종료 시까지</td>
                      <td>
                        <a href="mailto:privacy@zendesk.com">privacy@zendesk.com</a>
                      </td>
                    </tr>
                    <tr>
                      <td>Sendbird, Inc.</td>
                      ...
                      <td>상동</td>
                      <td>
                        <a href="mailto:privacy@sendbird.com">privacy@sendbird.com</a>
                      </td>
                    </tr>
                    <tr>
                      <td>MoEngage, Inc.</td>
                      <td>맞춤형 고객 서비스 (앱 푸시 / 메시지, 앱내 팝업 타켓팅)</td>
                      <td>
                        이전국가: 미국 <br />
                        이전 일시 및 방법: 서비스 이용 시점에 네트워크를 통한 전송
                      </td>
                      ...
                      <td>상동</td>
                      <td>
                        <a href="mailto:privacy@moengage.com">privacy@moengage.com</a>
                      </td>
                    </tr>
                    <tr>
                      <td>MixPanel, Inc.</td>
                      ...
                      <td>상동</td>
                      <td>
                        <a href="mailto:compliance@mixpanel.com">compliance@mixpanel.com</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="layout-box">
            <p className="layout-text">
              이용자는 회사의 개인정보보호책임자 및 담당부서를 통해 개인정보 국외 이전을 거부할 수 있습니다. 이용자가
              개인정보 국외 이전을 거부하는 경우 회사는 해당 이용자의 개인정보를 국외 이전 대상에서 제외 합니다. 이 경우
              회사의 서비스 중 개인정보 국외 이전이 필수적으로 수반되는 서비스의 이용에 제한이 될 수 있습니다.
            </p>
          </div>
        </article>
          ...
          <div className="layout-box">
            <ol className="lst-indent">
              <li>
                ...
                <ol className="lst-indent">
                  <li>
                    ...
                    <p className="layout-text">개인정보 열람 요구</p>
                  </li>
                  <li>
                    <span className="mark">②</span>
                    <p className="layout-text">오류 등이 있을 경우 정정 요구</p>
                  </li>
                  <li>
                    <span className="mark">③</span>
                    <p className="layout-text">삭제 요구</p>
                  </li>
                  <li>
                    <span className="mark">④</span>
                    <p className="layout-text">처리정지 요구</p>
                  </li>
                </ol>
              </li>
              <li>
                <span className="mark">2.</span>
                <p className="layout-text">
                  이용자는 서비스 내 ‘마이페이지 &gt; 설정 &gt; 계정정보’ 메뉴 및 서면, 전화, 전자우편, 모사전송(FAX)
                  등을 통하여 권리 행사를 하실 수 있으며 회사는 이에 대해 지체 없이 조치하겠습니다.
                </p>
              </li>
              <li>
                <span className="mark">3.</span>
                <p className="layout-text">
                  이용자가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는 회사는 정정 또는 삭제를 완료할
              ...
              <li>
                ...
                <p className="layout-text">
                  이용자에 따른 권리 행사는 이용자의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다.
              ...
              <li>
                ...
                <p className="layout-text">
                  이용자는 개인정보 보호법 등 관계법령을 위반하여 회사가 처리하고 있는 이용자 본인이나 타인 의 개인정보
                  및 사생활을 침해 하여서는 아니됩니다.
                </p>
              </li>
            </ol>
          </div>
          ...
          <div className="layout-box">
            <ol className="lst-indent">
              ...
              <li>
                ...
                <ul className="lst-indent circle-delim">
                  <li>
                    <p className="layout-text">iOS 설정 → 개인정보보호 → 광고 → 광고 추적 제한</p>
                  </li>
                  <li>
                    <p className="layout-text">
                      Android 설정 → 구글(구글설정) → 광고 → 광고 ID 삭제 (또는 맞춤설정 선택 해제)
                    </p>
                  </li>
                </ul>
              </li>
            ...
            <div className="table-box">
              <table className="table row-style privary-4">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>경찰청 사이버수사국</td>
                    <td>ecrm.cyber.go.kr/minwon/main </td>
                    <td>(국번 없이) 182</td>
                  </tr>
                  <tr>
                    <td>개인정보분쟁조정위원회</td>
        ...
        <article>
          ...
          <div className="layout-box">
            <p className="layout-text">
              이 개인정보처리방침은 2023년 11월 27일에 개정되었으며 정부의 정책 및 정보보호 유관법령 또는 보안기술의
              변경에 따라 내용의 추가, 삭제 및 수정이 있을 시에는 개정 최소 7일 전부터 서비스내 공지사항을 통해 고지할
              것입니다.
            </p>
          </div>
          <div className="layout-box">
            <ul className="lst-indent circle-delim">
              <li>
                <p className="layout-text">개인정보 처리방침 시행일자 : 2023년 11월 27일</p>
              </li>
            </ul>
          </div>
        </article>
        <article>
          <div className="layout-select layout-box">
            <Select size="medium" onChange={handleSelect}>
              {values.map((option) => (
      ...
      <div id="personalinfo" style={{ display: 'none' }}>
        ...
        <PersonalInfo />
        <div className="layout-box">
          <p className="layout-text">※ 개인정보 수집•이용 동의를 거부하실 수 있으나, 이 경우 회원가입이 제한됩니다.</p>
        </div>
      </div>
      ...
      <div id="onwardtransfer" style={{ display: 'none' }}>
      ...
      <div className="table-box">
        <table className="table">
          ...
          <tbody>
            <tr>
              <td>회원가입 시</td>
              <td>이메일 주소(아이디), SNS 계정 간편 가입시 (카카오ID:이름/이메일/프로필, 애플ID:이메일)</td>
              <td>
                - 회사는 원칙적으로 이용자의 개인정보를 회원 탈퇴 및 수집 목적 달성 시 지체없이 안전하게 파기하고,
                이용자에게 개인정보 보관 기간에 대해 별도 동의를 얻은 경우 해당 동의 내용에 따릅니다.
                <br />
            ...
            <tr>
              <td>상품 주문결제 시</td>
              <td>주문자 정보(휴대폰 인증을 통해 확인한 이름, 휴대폰번호), 결제신용카드정보(카드번호, 카드사명)</td>
              <td>상동</td>
            </tr>
            <tr>
              <td>상품 배송시</td>
            ...
            <tr>
              <td>여행/항공권 상품 구매시</td>
              <td>
                예약자(동행자 포함)의 성명(한글/영문명), 휴대전화번호, 생년월일, 성별, 여권 국적, 여권번호, 여권만료일,
                이메일
              </td>
              <td>상동</td>
            </tr>
            <tr>
              <td>고객 상담 시</td>
              <td>이메일주소, 주문정보(주문자 이름, 휴대폰번호, 주소)</td>
              <td>상동</td>
            </tr>
            <tr>
              <td>통계 분석 시</td>
              <td>서비스 이용정보(최근 접속일,이벤트로그), 기기정보(고유기기 식별값,OS버젼)</td>
              <td>상동</td>
            </tr>
          </tbody>
        </table>
...
const Marketing = () => {
  return (
    <>
      <div className="layout-box">
        <p className="layout-text">
          회사는 이용자의 마케팅 정보 수신동의 수신거부의사에 반하여 마케팅 정보를 전송하지 않습니다.
        </p>
        <p className="layout-text">
          마케팅 정보 수신 및 활용 동의 여부와 관계없이 회원가입 및 서비스를 이용하실 수 있습니다.
        </p>
        <p className="layout-text">
          또한 서비스의 중요 안내사항 및 주문/배송에 대한 정보는 마케팅 정보 수신동의 여부와 관계없이 발송됩니다.
        </p>
      </div>
      <div className="layout-table layout-box">
        <div className="table-box">
...
const Onwardtransfer = () => {
  ...
  return (
    <>
      <div className="layout-box">
        <p className="layout-text">
          회사는 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 단, 주문과 결제가 이루어진 경우, 상담 및 배송
          등 원활한 거래 이행을 위하여 관련된 정보를 필요한 범위 내에서 판매자(제3자)에게 전달합니다. 주문 시에만
          판매자(제3자)에게 개인정보가 제공 되며 주문 시 안내 해드립니다. 판매자(제3자)에게 개인정보 제공을 거부하실 수
          있으나, 이 경우 서비스 이용이 제한될 수 있습니다.
        </p>
      </div>
      <div className="layout-table layout-box">
        <div className="table-box">
          <table className="table row-style privary-4">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  - 상품 주문 확인 및 배송 업무
                  <br />- 고객 상담 및 불만, 민원 사무처리
                  <br />- 여행/항공권 예약 및 발권 서비스 제공
                </td>
              </tr>
              <tr>
                <td>제공 정보</td>
                <td>
                  <span>- 이름, 휴대폰번호, 이메일, 배송지 주소 (구매자와 수취인이 다를 경우 수취인의 정보 제공)</span>
                  <br />
                  <span>
                    - 여행/항공권 상품의 경우 예약자(동행자 포함)의 성명(한글/영문명), 휴대전화번호, 생년월일, 성별,
                    여권 국적, 여권번호, 여권만료일, 이메일
                  </span>
                </td>
              </tr>
              <tr>
