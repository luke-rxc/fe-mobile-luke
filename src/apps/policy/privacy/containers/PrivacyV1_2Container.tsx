...
export const PrivacyV1_2Container = () => {
    ...
    <Layout className={isApp ? 'app' : ''} title="개인정보 처리방침" headerTriggerRef={headerTriggerRef}>
      <div id="policy-all">
        ...
        <article>
          ...
          <div className="layout-box">
            <p className="layout-text">
              이 개인정보처리방침은 2022년 12월 19일에 개정되었으며 정부의 정책 및 정보보호 유관법령 또는 보안기술의
          ...
          <div className="layout-box">
            <ul className="lst-indent circle-delim">
              <li>
                <p className="layout-text">개인정보 처리방침 시행일자 : 2022년 12월 19일</p>
              </li>
            </ul>
          </div>
        </article>
        <article>
          <div className="layout-select layout-box">
            <Select size="medium" onChange={handleSelect} value="v1_2">
              {values.map((option) => (
