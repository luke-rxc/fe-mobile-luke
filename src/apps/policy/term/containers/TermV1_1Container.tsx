...
export const TermV1_1Container = () => {
  ...
  return (
    <Layout className={isApp ? 'app' : ''} title="이용약관" headerTriggerRef={headerTriggerRef}>
      <div id="policy-all">
          ...
          <div className="layout-box">
            <ol className="lst-indent">
              ...
              <li>
                <span className="mark">3.</span>
                <p className="layout-text">
                  이용자는 제15조에서 정한 바에 따라 반품, 교환, 청약철회 등의 의사표시를 할 수 있습니다. 만약 이용자가
                  정해진 기간내에 구매확정 또는 청약철회 등의 의사표시를 하지 않을 경우 자동으로 구매확정을 한 것으로
                  간주됩니다.
                </p>
              </li>
            </ol>
        ...
        <article>
          ...
          <div className="layout-box">
            <p className="layout-text">
              ...
              환급하거나 환급에 필요한 조치를 취합니다. 다만, 티켓 (전시, 공연, 여행, 숙박 등)의 경우 서비스에 별도로
              공지한 환급기준에 따릅니다.
            </p>
          </div>
        </article>
            ...
            <ol className="lst-indent">
              <li>
                ...
                <p className="layout-text">
                  ...
                  정함이 있는 경우에는 동 법 규정에 따릅니다. 티켓 (전시, 공연, 여행, 숙박 등)의 경우 서비스에 별도로
                  공지한 환급기준에 따르며, 별도의 취소 수수료가 부과될 수 있습니다.
                </p>
              </li>
              <li>
                <span className="mark">2.</span>
        ...
        <article>
          <h2>제15조의1 (티켓의 청약 철회 등)</h2>
          <div className="layout-box">
            <ol className="lst-indent">
              <li>
                <span className="mark">1.</span>
                <p className="layout-text">
                  제15조에도 불구하고, 티켓 (전시, 공연, 여행, 숙박 등)의 경우 예약 및 그에 따른 서비스 준비 등의 특수한
                  사정이 있는 관계로 개별판매 조건에 명시된 유효기간 및 조건에 한하여 서비스가 제공되며, 별도의
                  취소/환불 규정을 따릅니다.
                </p>
              </li>
              <li>
                <span className="mark">2.</span>
                <p className="layout-text">
                  “이용자”는 서비스에 명시된 내용 및 개별 주의사항(상품설명 등)을 확인하여야 할 책임이 있습니다.
                </p>
              </li>
            </ol>
          </div>
          ...
          <div className="layout-box">
            <ol className="lst-indent">
              <li>
                <span className="mark">1.</span>
                <p className="layout-text">
                  회사는 회원이 상품 구매, 구매 상품리뷰 및 이벤트 참여 등의 “몰”을 이용하는 과정에서 회원에게 일정한
                  적립금을 부여할 수 있습니다. 이러한 적립금의 부여에 대한 구체적인 운영 방법은 회사의 운영 정책에
                  우선합니다.
                </p>
                <ol className="lst-indent">
                  <li>
        ...
        <article>
          <div className="layout-box">
            <ul className="lst-indent circle-delim" style={{ marginTop: '2rem' }}>
              <li>
                <p className="layout-text">현행 서비스이용약관 시행일자 : 2023년 4월 13일</p>
              </li>
            </ul>
          </div>
        </article>
        <article>
          <div className="layout-select layout-box">
            <Select size="medium" onChange={handleSelect} value="v1_1">
              {values.map((option) => (
