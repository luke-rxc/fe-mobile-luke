...
export const useFloatingDismissService = ({
  ...
  const addEvents = useCallback((el: HTMLElement) => {
    el.addEventListener('touchstart', handlerTouchAction, false);
    el.addEventListener('touchmove', handlerTouchAction, false);
    el.addEventListener('touchcancel', handlerTouchAction, false);
    el.addEventListener('touchend', handlerTouchAction, false);
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);

  const removeEvents = useCallback((el: HTMLElement) => {
    el.removeEventListener('touchstart', handlerTouchAction, false);
    el.removeEventListener('touchmove', handlerTouchAction, false);
    el.removeEventListener('touchcancel', handlerTouchAction, false);
    el.removeEventListener('touchend', handlerTouchAction, false);
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);
