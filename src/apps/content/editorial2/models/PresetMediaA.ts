import { AlignType, ContentsBackgroundType, TextItemSizeType, VerticalAlignType } from '../constants';
import type {
  BackgroundInfoModel,
  DisplayMediaModel,
...
export type MediaAParallaxStyledModel = {
  verticalAlign: VerticalAlignType;
  parallaxMode: boolean;
  background: {
    type: Omit<ContentsBackgroundType, 'COLOR'>;
