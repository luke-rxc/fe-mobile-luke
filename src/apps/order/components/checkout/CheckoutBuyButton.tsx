import React, { useEffect, useState, useContext, useRef, HTMLAttributes } from 'react';
...
export const CheckoutBuyButton = ({
  checkoutInfo,
  isLoading,
  ...
  return (
    <ContainerStyled {...rest} className={classNames(className, { guide: expiredDate || !isEmpty(guideMessages) })}>
      <div className="button-wrapper">
        <div className="mask-field" />
        {expiredDate && (
          <PopupEffect ref={popupElRef} onTransitionEnd={handleTransitionEnd}>
            <SeatTimer ref={timerElRef} expiredDate={expiredDate} onExpired={handleExpired} />
          </PopupEffect>
        )}
